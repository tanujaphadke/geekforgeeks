...
public class RottonOrangeV2 {
	class Solution {
		...
		public Set<String> rotOranges(int[][] grid, Set<String> rottonCoordinates) {
			...
			Set<String> latestRottonCoordiantes = new HashSet<>();
			latestRottonCoordiantes.addAll(rottonCoordinates);
			latestRottonCoordiantes.addAll(rottonAdj);
			return latestRottonCoordiantes;
		}
		...
		public int orangesRotting(int[][] grid) {
			...
			rotten = initRottonCoordinates(grid);
