...
public class BinaryTreeBottomView {
    ...
    private static Map<Node4, Integer> Node4DistanceMap = new HashMap<>();

    public static void bottomView(List<Node4> parentNode4s) {
        ...
        for (Node4 parent : parentNode4s) {
            ...
            if (parent.left != null) {
                ...
                Node4DistanceMap.put(parent.left, leftDistanceFromRoot);
            ...
            if (parent.right != null) {
                ...
                Node4DistanceMap.put(parent.right, righttDistanceFromRoot);
            }
        }
